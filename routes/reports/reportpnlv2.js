    ...
    try {
      ...
      ;WITH AllData AS (
          ...
          SELECT
              ...
              case when g.KodeGl = '410101' or g.kodegl='710001' or g.kodegl='710099' then abs(sum(gti.JlhDebit)-sum(gti.JlhKredit))
      ...
      Calc AS (
          SELECT
              ...
              MAX(CASE WHEN KodeGl = '710099'               THEN TahunIni  ELSE 0 END) as Klaim_Now,
              MAX(CASE WHEN KodeGl = '710099'               THEN TahunLalu ELSE 0 END) as Klaim_Prev,
              ...
              MAX(CASE WHEN KodeGl = '710099'               THEN YtdIni  ELSE 0 END) as Klaim_NowYtd,
              MAX(CASE WHEN KodeGl = '710099'               THEN YtdLalu ELSE 0 END) as Klaim_PrevYtd,
